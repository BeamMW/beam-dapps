...
import { BaseComponent, Button, ParamsInput } from '@components/shared';
import { Tags } from '@constants/html-elements';
import { actionColorsData, buttonsData, svgData } from '@lib/data';
import { RC, AC } from '@logic/action-creators';
import { STORE, BEAM } from '@logic/controllers';
import ActionLogic from '@logic/observers/actions.logic';
