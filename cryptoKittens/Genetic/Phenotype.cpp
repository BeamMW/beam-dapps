...
void Phenotype::setPhenotype(const genotype& genotype) noexcept
{
...
void Phenotype::setGenMeaning(const ChromosomeMask& chromosomeMask, genotype::const_iterator& chromosomeIt) noexcept
{
