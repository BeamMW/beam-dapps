export const buttonDropInnerHtml = `
<svg class="chooseWasm__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
...
<span class="chooseWasm__text">Drag and drop  or attach .wasm file</span>
`;
